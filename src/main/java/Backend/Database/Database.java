...
public abstract class Database<D extends Info> {
    ...
    protected JSONArray readAllUsersArray() {
        try {
    ...
    protected boolean writeAllUsersArray(JSONArray arr) {
    ...
    protected void updateUserInFile(int userId, JSONObject updated) {
